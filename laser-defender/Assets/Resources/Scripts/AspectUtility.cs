...
{
	[SerializeField] private static float wantedAspectRatio = 0.5625f;
	private static float cameraWantedAspectRatio;
	...
	public static int OffsetX => (int) (Screen.width * cam.rect.x);
 
	public static int OffsetY => (int) (Screen.height * cam.rect.y);
 
	public static Rect ScreenRect 
	{
		get => new Rect (cam.rect.x * Screen.width, cam.rect.y * Screen.height, cam.rect.width * Screen.width, cam.rect.height * Screen.height);
	}
	...
	private void Awake ()
	{
		...
		cameraWantedAspectRatio = wantedAspectRatio;
		SetCamera();
	}
